...
import TextOverlay from "./TextOverlayEdu";
...
export default function GridOverlay({ texts }) {
  ...
  const linkGroups = [
    { numbers: [0,1,2,20,21,22,40,41,42,43,60,61,62,63,80,81,82,83,84,100,101,102,103,104,105,106,107,120,121,122,123,124,125,126,127,140,141,142,143,144,145,146,147,160,161,162,163,164,165,166,167,180,181,182,183,184,185,186,187,200,201,202,203,204,205,206,207,225,226,227], url: "/pagina1" },
    { numbers: [260,261,262,263,264,280,281,282,283,284,300,301,302,303,304,320,321,322,323,324,325,340,341,342,343,344,345,360,361,362,363,364,365,366], url: "/" },

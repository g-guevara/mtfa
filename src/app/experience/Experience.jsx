...
export default function HomeContent() {
  ...
  const [texts, setTexts] = useState([
    ...
    { id: 32, x: 33, y: 59, text: "- Assisted two magistrates in the preparation of their thesis, and optimization and maintenance of the photovoltaic plant, working with suppliers and professors.", rotation: 0, scaleRotation: 0, rotationDirection: -1, url: "" },
    ...
    { id: 332, x: 33, y: 59, text: "- Assisted two magistrates in the preparation of their thesis, and optimization and maintenance of the photovoltaic plant, working with suppliers and professors.", rotation: 0, scaleRotation: 0, rotationDirection: -1, url: "" },
